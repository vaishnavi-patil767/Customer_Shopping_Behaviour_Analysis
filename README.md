...
This project focuses on analyzing customer shopping behavior using a complete end-to-end data analytics workflow. The goal is to uncover actionable business insights related to customer segments, spending patterns, discounts, and product performance.
The project demonstrates practical skills in Python, SQL, Power BI, and business reporting, making it suitable for data analyst and business analyst roles.
